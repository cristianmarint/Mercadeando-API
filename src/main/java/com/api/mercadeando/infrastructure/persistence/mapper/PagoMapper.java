...
public class PagoMapper {
    public Pago mapPagoRequestToPago(PagoRequest request, Pago pago) throws BadRequestException {
        ...
        if (request.getPaypalPaymentId()!=null) pago.setPaypalPaymentId(request.getPaypalPaymentId());
    ...
    public PagoResponse mapPagoToPagoResponse(Pago pago) {
        ...
        if (pago.getPaypalPaymentId()!=null) response.setPaypalPaymentId(pago.getPaypalPaymentId());
